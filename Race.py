...
def main():
    ...
    class CAR:
        ...
        def draw_car(self):
            ...
            if self.car_rect.left <= 17: self.car_rect.left = 17 #self.car_speed[0] = 2
            if self.car_rect.right >= width-20: self.car_rect.right = width-20 #self.car_speed[0] = -2
    ...
    class MAIN:
        ...
        def check_collision(self):
            ...
            for rect in self.objects:
                if self.car.car_rect.colliderect(rect):
    ...
    while True:
        for event in pygame.event.get():
            ...
            if event.type == pygame.KEYDOWN:
                if event.key == pygame.K_DOWN:
                    main_game.car.car_speed[1] = 1
                if event.key == pygame.K_UP:
                    main_game.car.car_speed[1] = -2
                if event.key ==pygame.K_LEFT:
                    main_game.car.car_speed[0] = -4  
        ...
        '''if main_game.score >= 30:
            object_speed = 15
        elif main_game.score >= 20:
            object_speed = 10
        elif main_game.score >= 10:
            object_speed = 5
        else:
            object_speed = 3'''
